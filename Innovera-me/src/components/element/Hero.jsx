...
const Hero = () => {
  return (
    <div
      ...
      style={{ backgroundImage: "url('/bg-img.png')" }} id="home">
      <div className="text-center flex flex-col items-center z-10">
        ...
        <div className="mt-8 flex flex-wrap gap-4 justify-center z-10">
          <a href ="https://unstop.com/p/innov-era-national-level-hackathon-kkwagh-college-of-engineering-and-researchnashik-1374664" className="bg-white text-black font-medium px-6 py-2 rounded-full border border-white hover:text-white transition z-10 hover:bg-black">
            Register
          </a>
